...
public class ZebreExtension {
	...
	public static void main(String[] args) {
        ...
        int [][] d =new int[][] {{1,2},{2,3},{3,4},{4,5}};
        int [][] g=new int[][] {{2,1},{3,2},{4,3},{5,4}};
        int [][] nextto= new int[][] {{1,2},{2,3},{3,4},{4,5},{2,1},{3,2},{4,3},{5,4}};
        
        Tuples tuplesg=new Tuples(g,true);
        Tuples tuplesd=new Tuples(d,true);
        Tuples tuples_nextto=new Tuples(nextto,true);
        ...
        model.table(new IntVar[]{ivo,gre},tuplesd).post();
        ...
        model.table(new IntVar[]{nor,blu},tuples_nextto).post();

 ...
 * 
 */
@WebServiceClient(name = "MathServiceImplService", targetNamespace = "http://server.demo.tp2.hai704i/", wsdlLocation = "http://localhost:8080/mathservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MATHSERVICEIMPLSERVICE_QNAME = new QName("http://server.demo.tp2.hai704i/", "MathServiceImplService");
    ...
    public MathService getMathServiceImplPort() {
        return super.getPort(new QName("http://server.demo.tp2.hai704i/", "MathServiceImplPort"), MathService.class);
    }
    ...
    public MathService getMathServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.demo.tp2.hai704i/", "MathServiceImplPort"), MathService.class, features);
    }

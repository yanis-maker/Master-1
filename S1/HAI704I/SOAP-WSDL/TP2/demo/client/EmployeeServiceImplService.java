 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://service.demo.tp2.hai704i/", wsdlLocation = "http://localhost:8080/employeeservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICEIMPLSERVICE_QNAME = new QName("http://service.demo.tp2.hai704i/", "EmployeeServiceImplService");
    ...
    public EmployeeService getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://service.demo.tp2.hai704i/", "EmployeeServiceImplPort"), EmployeeService.class);
    }
    ...
    public EmployeeService getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.demo.tp2.hai704i/", "EmployeeServiceImplPort"), EmployeeService.class, features);
    }

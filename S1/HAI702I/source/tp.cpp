...
int main(int argc, char **argv) {
    ...
    //Add a translation
    Mat3 rotation = Mat3(cos(90/3.14), -sin(90/3.14), 0,
                        sin(90/3.14),  cos(90/3.14), 0.,
                        0.,  0., 1.);

    Mat3 rotation2 = Mat3(cos(90),0,sin(90),
                          0., 1., 0.,
                        -sin(90),0.,cos(90));

    Mat3 rotation3 = Mat3(1.,0.,0.,
                          0.,cos(90),-sin(90),
                          0.,sin(90),cos(90));

    Mat3 scale = Mat3(1.,0.,0.,
                      0.,1.,0.,
                      0.,0.,1.);
                            
    Vec3 translation = Vec3(1., 0., 0.);

    Mat3 transformation2=rotation2*scale;


    for (unsigned int i = 0; i < transformed_mesh.vertices.size(); i++) {
        transformed_mesh.vertices[i] = transformation2*transformed_mesh.vertices[i] + translation;
    }
    ...
    for (unsigned int i = 0; i < transformed_mesh.normals.size(); i++) {
        ...
        transformed_mesh.normals[i] = transformation2*transformed_mesh.normals[i];
    }
